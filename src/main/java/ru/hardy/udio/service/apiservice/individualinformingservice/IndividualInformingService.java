...
import ru.hardy.udio.repo.apirepo.individualinforming.IndividualInformingRepo;
...
public class IndividualInformingService {
    ...
    public void add(People people, IndividualInformingRequestRecord individualInformingRequestRecord, int codeMO) {
        ...
        individualInforming.setCodeMO(codeMO);
