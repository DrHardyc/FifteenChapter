...
import ru.hardy.udio.service.apiservice.numberavailableseatsservice.mo.DateNumberVacantPlacesActualService;
import ru.hardy.udio.service.apiservice.numberavailableseatsservice.mo.NumberAvailableSeatsService;
...
public class NumberAvailableSeatsDTOService {
    ...
    public List<NumberAvailableSeatsDTO> getAllByMO(int codeMO){
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd.MM.yyyy");
        List<NumberAvailableSeatsDTO> numberAvailableSeatsDTOS = new ArrayList<>();

        numberAvailableSeatsService.getAllByMO(codeMO).forEach(numberAvailableSeats -> {
            ...
            numberAvailableSeatsDTO.setCode(numberAvailableSeats.getRequestRecord().getCodeDep());
