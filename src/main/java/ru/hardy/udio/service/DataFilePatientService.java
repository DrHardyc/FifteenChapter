...
public class DataFilePatientService {
    ...
    public void getFromBars() throws SQLException {
        ...
        ResultSet resultSet = statement.executeQuery("select cbp.pac_fam, cbp.pac_im, cbp.pac_ot, cbp.pac_dr, " +
                "coalesce(cb.enp, cb.npolis), ms.code, dg.code, cb.nhistory, mkb.mkb_code, mhp.code, mor.reg_code, " +
                "cb.date_1, cb.date_2 " +
