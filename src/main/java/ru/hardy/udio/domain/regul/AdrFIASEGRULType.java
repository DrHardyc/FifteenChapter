...
@Getter
@Setter
@Table(schema = "regul", name = "adr_fias_egrul_type")
@XmlRootElement(name = "АдрФИАСЕГРЮЛТип")
public class AdrFIASEGRULType {
    @Id
    private Long id;
    ...
    @MappedCollection(idColumn = "adrfiasegrultype_id")
    ...
    @MappedCollection(idColumn = "adrfiasegrultype_id")
    private Set<NumberPType> numberPTypeZdanie;
    @MappedCollection(idColumn = "adrfiasegrultype_id")
    ...
    public void setNumberPTypeZdanie(Set<NumberPType> numberPTypeZdanie) {
